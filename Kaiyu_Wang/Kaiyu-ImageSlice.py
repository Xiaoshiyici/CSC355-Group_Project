...
# Save the output images
    image1.crop((0, 0, width, height / 2)).save('output1a.jpg')
    image1.crop((0, height / 2, width, height)).save('output1b.jpg')
    image2.crop((0, 0, width, height / 2)).save('output2a.jpg')
    image2.crop((0, height / 2, width, height)).save('output2b.jpg')
